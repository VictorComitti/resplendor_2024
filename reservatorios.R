...
# correlação bombeamento precipitação ------------------------------------------
...
dados <- list(dados_reservatorios, dados_precipitacao, dados_bombeamento)

files_names <- c("reservatorios.rds",
                 "precipitacao.rds",
                 "bombeamento.rds") %>%
  paste0("resplendor_",2024,"-",.)
